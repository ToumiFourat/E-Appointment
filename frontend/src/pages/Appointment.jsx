    ...
    return docInfo && (
        <div className="px-4 sm:px-6 md:px-10" >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <div>
                        <p className="flex items-center gap-1 text-sm font-medium text-gray-900 mt-3">À propos <img src={assets.info_icon} alt="" /></p>
                        <p className="text-sm text-gray-500 max-w-[700px] mt-1">{docInfo.about}</p>
                    </div>
                    <p className="text-gray-500 font-medium mt-4">Frais de rendez-vous : <span className="text-gray-600">{docInfo.fees}</span> {currencySymbol}</p>
            ...
            <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
                ...
                <button className="bg-blue-300 text-white text-sm font-light flex-shrink-0 px-14 py-3 rounded-full my-6 ">
                Prendre rendez-vous
                </button>
